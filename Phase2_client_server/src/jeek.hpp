...
public:
	Jeek();
	bool add_jeek(string username , int num , string text , string new_tag , string new_mention , string command);
	bool search_jeek(string jeek_id);
	string show_jeek(string user_display_name);
	...
	string show(string user_display_name);
